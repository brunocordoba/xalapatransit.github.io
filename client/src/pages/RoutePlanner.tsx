...
import { CalendarIcon, Clock10Icon, Clock3Icon, ArrowUpDown, Navigation2Icon, XIcon } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                <div className="relative">
                  <Input 
                    ...
                    placeholder="Inicio" 
                  />
                  <Navigation2Icon className="absolute left-3 top-3 h-5 w-5 text-muted-foreground" />
                  {startLocation && (
                    <Button 
                      variant="ghost" 
                      size="icon" 
